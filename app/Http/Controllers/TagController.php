...
class TagController extends Controller
{
    ...
    {
        $request->validate([
            'name' => 'required|string|max:50|unique:menus,title',
            'image' => 'required|image|mimes:jpeg,png,jpg,webp|max:2048'
        ],[
            'name.unique' => 'ဒီအမည်နဲ့ Menu Tag ရှိနေပြီးသား ဖြစ်နေပါတယ်!',
            'image.image' => 'တင်လိုက်သော ဖိုင်သည် ပုံရိပ်အမျိုးအစား (Image) ဖြစ်ရပါမည်!',
            'image.mimes' => 'ပုံစံမမှန်ပါ။ jpeg, png, jpg, webp အမျိုးအစားများသာ လက်ခံပါသည်!',
            'image.max' => 'ပုံ၏အရွယ်အစားသည် 2MB ထက် မကျော်ရပါ!'
        ]);
